...
class alien(IStrategy):
    ...
    buy_params = {
        ...
        ##
        "ewo_high": 11.141,#2.615
        "ewo_high2": 6.361,#2.188
        "ewo_low": -10.387,#-19.632
        "ewo_low2": -17.313,#-19.955
        "rsi_buy": 51,#60
        "rsi_buy2": 31,#45
        #
        "pump_protection_01_pct_change_timeframe": 5,#8
        "pump_protection_01_pct_change_max": 0.205,#0.15
        "pump_protection_01_pct_change_min": -0.112,#-0.15
        #
        "pump_protection_01_pct_change_short_timeframe": 6,#8
        "pump_protection_01_pct_change_short_max": 0.083,#0.1
        "pump_protection_01_pct_change_short_min": -0.139,#-0.1
        #
        "pump_protection_01_ispumping": 0.208,#0.2
        "pump_protection_01_islongpumping": 0.219,#0.24
        "pump_protection_01_isshortpumping": 0.107,#0.12
        #
        ...
        ##
        "lambo2_ema_14_factor": 0.938,#0.981
        "lambo2_enabled": True,
        "lambo2_rsi_14_limit": 49,#39
        "lambo2_rsi_4_limit": 25,#44
        ##
        "buy_adx": 13,
        "buy_cofi_r14": -85.016,
        "buy_cofi_cti": -0.892,
        ...
        #
        "base_nb_candles_buy": 9,#8
        "ewo_high": 4.13,
        "ewo_high_2": 4.477,
        "ewo_low": -19.076,
        "lookback_candles": 17,#27
        "low_offset": 0.983,#0.988
        "low_offset_2": 0.96,#0.974
        "profit_threshold": 0.998,#1.049
        "rsi_buy": 51,#72
        "rsi_fast_buy": 45,#40
        #
    ...
    buy_nfix_39_ema = DecimalParameter(0.9, 1.2, default=0.974 , optimize = is_optimize_nfix_39)#0.97
...
class UziChanTB2(alien):
    ...
    trailing_sell_order_enabled = False    
