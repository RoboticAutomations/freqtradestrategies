...
class ichiV1(IStrategy):
    ...
    buy_params = {
        ...
        "buy_min_fan_magnitude_gain": 1.004 # NOTE: Good value (Win% ~70%), alot of trades
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
       ...
       # dataframe['close'] = heikinashi['close']
        ...
        dataframe['trend_close_15m'] = ta.EMA(dataframe['close'], timeperiod=2)
        dataframe['trend_close_30m'] = ta.EMA(dataframe['close'], timeperiod=3)
        dataframe['trend_close_1h'] = ta.EMA(dataframe['close'], timeperiod=5)
        dataframe['trend_close_2h'] = ta.EMA(dataframe['close'], timeperiod=8)
        dataframe['trend_close_4h'] = ta.EMA(dataframe['close'], timeperiod=13)
        dataframe['trend_close_6h'] = ta.EMA(dataframe['close'], timeperiod=21)
        dataframe['trend_close_8h'] = ta.EMA(dataframe['close'], timeperiod=34)

        dataframe['trend_open_5m'] = dataframe['open']
        dataframe['trend_open_15m'] = ta.EMA(dataframe['open'], timeperiod=2)
        dataframe['trend_open_30m'] = ta.EMA(dataframe['open'], timeperiod=3)
        dataframe['trend_open_1h'] = ta.EMA(dataframe['open'], timeperiod=5)
        dataframe['trend_open_2h'] = ta.EMA(dataframe['open'], timeperiod=8)
        dataframe['trend_open_4h'] = ta.EMA(dataframe['open'], timeperiod=13)
        dataframe['trend_open_6h'] = ta.EMA(dataframe['open'], timeperiod=12)
        dataframe['trend_open_8h'] = ta.EMA(dataframe['open'], timeperiod=34)
