...
#command = freqtrade backtesting --strategy generated_strategy79_v1 --config backtest_configs/futures_100_hyperliquid.json --timerange 20240101- --timeframe 1h --max-open-trades 4 --cache none --dry-run-wallet 1000

def lerp(a: float, b: float, t: float) -> float:
    return (1 - t) * a + t * b

class generated_strategy79_v1(IStrategy):    
    ...
    profit_ratio_needed = DecimalParameter(-0.100, 0.200, decimals=3, default=0.177, space="sell", optimize=True)
    exit_only_profit = BooleanParameter(default=False, space="sell", optimize=True)
    max_hold_hours = CategoricalParameter([8, 16, 24, 48, 72, 96, 120, 150, 200, 250, 300, 350, 400, 450, 500, 750, 1000, 1250, 1500], default=16, space="sell", optimize=True)
    ...
    my_custom_stoploss = DecimalParameter(-0.9, -0.1, decimals=1, default=-0.63, space="sell", optimize=True)
    ...
    partial_profit_pct_1 = DecimalParameter(0.005, 0.50, default=0.488, space="sell", optimize=True, decimals=3)
    partial_profit_pct_2 = DecimalParameter(0.01, 1.00, default=0.013, space="sell", optimize=True, decimals=3)
    partial_profit_pct_3 = DecimalParameter(0.02, 1.50, default=1.424, space="sell", optimize=True, decimals=3)
    partial_profit_pct_4 = DecimalParameter(0.05, 2.00, default=1.083, space="sell", optimize=True, decimals=3)
    ...
    parabolic_gain_threshold = DecimalParameter(0.10, 0.50, default=0.12, space="sell", optimize=True, decimals=2)
    ...
    max_daily_loss_pct = DecimalParameter(0.01, 0.10, default=0.045, space="buy", optimize=True, decimals=3)
    ...
    trailing_buy_pct = DecimalParameter(0.001, 0.10, default=0.07, space="buy", optimize=True, decimals=3)
    trailing_buy_max_distance = DecimalParameter(0.01, 0.20, default=0.086, space="buy", optimize=True, decimals=3)
    ...
    walcl_ema_size = CategoricalParameter([14,42,72,84,126,168,212,256,300,400,500], default=42, space="buy", optimize=True)
    ...
    volatility_max_filter_stake = DecimalParameter(0.01, 0.30, default=0.231, space="buy", optimize=True, decimals=3)
    ...
    volume_stake_max_threshold = CategoricalParameter([25_000, 50_000, 75_000, 100_000, 250_000, 500_000, 750_000, 1_000_000, 1_500_000, 2_000_000, 3_000_000, 5_000_000, 7_500_000, 10_000_000], default=500000, space="buy", optimize=True)
    volume_stake_min_ratio = DecimalParameter(0.5, 1.0, default=0.61, space="buy", optimize=True, decimals=2)
    volume_stake_max_ratio = DecimalParameter(0.5, 1.0, default=0.87, space="buy", optimize=True, decimals=2)
    
    use_drawdown_sizing = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    drawdown_threshold = DecimalParameter(0.05, 0.30, default=0.21, space="buy", optimize=True, decimals=2)
    drawdown_reduction = DecimalParameter(0.3, 0.8, default=0.35, space="buy", optimize=True, decimals=2)
    ...
    initial_safety_order_trigger = DecimalParameter(-0.5, 0.0, decimals=3, default=-0.14, space="buy", optimize=True)
    ...
    time_based_dca_candles = CategoricalParameter([1, 2, 4, 8, 12, 24, 48], default=48, space="buy", optimize=True)
    ...
    min_volume_filter = CategoricalParameter([5_000, 10_000, 20_000, 50_000, 75_000, 100_000, 150_000, 200_000, 300_000, 400_000, 500_000, 750_000, 1_000_000], default=75000, space="buy", optimize=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['over_ROC_13_11_5'] = clean_ta.momentum.ROCIndicator(close=dataframe['close'], window=143).roc()
        return dataframe
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append((atr_pct < 0.046))
        if conditions:
            dataframe.loc[
...
strategy_generator_json = {
    ...
    "params": {
        ...
        "buy": {
            ...
            "volatility_max_filter_stake": 0.231,
            "volatility_size": 12,
            "volatility_size1": "p9",
            "volatility_size2": "p2",
            "volatility_size3": "p13",
            "volatility_size_stake": 20,
            "volatility_threshold": 0.046,
            "volume_rolling": 24,
            "volume_spike_threshold": 2.0,
            "volume_spike_window": 50,
            "volume_stake_max_ratio": 0.87,
            "volume_stake_max_threshold": 500000,
            "volume_stake_min_ratio": 0.61,
        ...
        "sell": {
            ...
            "max_hold_hours": 16,
            "my_custom_stoploss": -0.63,
            "over_sell_conditions": 2,
            "over_sell_value": "p1",
            "over_use_sell": false,
            "parabolic_gain_threshold": 0.12,
            "parabolic_lookback": 15,
            "partial_profit_levels": 2,
            "partial_profit_pct_1": 0.488,
            "partial_profit_pct_2": 0.013,
            "partial_profit_pct_3": 1.424,
            "partial_profit_pct_4": 1.083,
            "profit_ratio_needed": 0.177,
            "trend_sell_conditions": 8,
    ...
    "ft_stratparam_v": 1,
    "export_time": "2025-09-09 20:04:42.097645+00:00"
}
"""
