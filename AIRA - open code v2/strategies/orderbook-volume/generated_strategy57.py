...
#   timerange = 20240101-
#   hyperoptloss = MoutonHyperOptLoss
#   spaces = buy sell

#command = freqtrade backtesting --strategy generated_strategy57_v1 --config backtest_configs/futures_hyperliquid.json --timerange 20240101- --timeframe 2h --max-open-trades 15 --cache none --dry-run-wallet 1000

def lerp(a: float, b: float, t: float) -> float:
    return (1 - t) * a + t * b

class generated_strategy57_v1(IStrategy):    
    ...
    profit_ratio_needed = DecimalParameter(-0.100, 0.200, decimals=3, default=-0.039, space="sell", optimize=True)
    exit_only_profit = BooleanParameter(default=False, space="sell", optimize=True)
    max_hold_hours = CategoricalParameter([8, 16, 24, 48, 72, 96, 120, 150, 200, 250, 300, 350, 400, 450, 500, 750, 1000, 1250, 1500], default=200, space="sell", optimize=True)
    ...
    my_custom_stoploss = DecimalParameter(-0.9, -0.1, decimals=1, default=-0.7, space="sell", optimize=True)
    ...
    partial_profit_pct_1 = DecimalParameter(0.005, 0.50, default=0.3, space="sell", optimize=True, decimals=3)
    partial_profit_pct_2 = DecimalParameter(0.01, 1.00, default=0.745, space="sell", optimize=True, decimals=3)
    partial_profit_pct_3 = DecimalParameter(0.02, 1.50, default=1.302, space="sell", optimize=True, decimals=3)
    partial_profit_pct_4 = DecimalParameter(0.05, 2.00, default=0.146, space="sell", optimize=True, decimals=3)
    
    use_parabolic_exit = CategoricalParameter([True, False], default=False, space="sell", optimize=True)
    parabolic_lookback = CategoricalParameter([3, 5, 7, 10, 15], default=10, space="sell", optimize=True)
    parabolic_gain_threshold = DecimalParameter(0.10, 0.50, default=0.37, space="sell", optimize=True, decimals=2)
    ...
    max_daily_loss_pct = DecimalParameter(0.01, 0.10, default=0.014, space="buy", optimize=True, decimals=3)
    
    entry_mode = CategoricalParameter(["none", "entry_scaling", "trailing_buy"], default="trailing_buy", space="buy", optimize=True)
    
    entry_scaling_orders = CategoricalParameter([2, 3, 4, 5], default=4, space="buy", optimize=True)
    entry_scaling_mode = CategoricalParameter(["equal", "increasing", "decreasing"], default="decreasing", space="buy", optimize=True)
    
    trailing_buy_pct = DecimalParameter(0.001, 0.10, default=0.095, space="buy", optimize=True, decimals=3)
    trailing_buy_max_distance = DecimalParameter(0.01, 0.20, default=0.108, space="buy", optimize=True, decimals=3)
    trailing_buy_max_hours = CategoricalParameter([1, 2, 4, 8, 12, 24, 48], default=24, space="buy", optimize=True)
    ...
    volatility_size = CategoricalParameter([4,6,8,10,12,14,16,20, 25, 30, 35, 40], default=35, space="buy", optimize=True)
    ...
    walcl_size = CategoricalParameter([7, 14, 50, 72, 100, 200, 300, 45, 46], default=72, space="buy", optimize=True)
    walcl_ema_size = CategoricalParameter([14,42,72,84,126,168,212,256,300,400,500], default=212, space="buy", optimize=True)
    walcl_stake_mode = CategoricalParameter([1,2,3,4,5,6], default=4, space="buy", optimize=True)
    walcl_adjustment = CategoricalParameter([0.25, 0.5, 0.75], default=0.75, space="buy", optimize=True)
    
    volatility_size_stake = CategoricalParameter([4, 6, 8, 10, 12, 14, 16, 20, 25], default=25, space="buy", optimize=True)
    volatility_max_filter_stake = DecimalParameter(0.01, 0.30, default=0.265, space="buy", optimize=True, decimals=3)
    ...
    volume_stake_min_ratio = DecimalParameter(0.5, 1.0, default=0.54, space="buy", optimize=True, decimals=2)
    volume_stake_max_ratio = DecimalParameter(0.5, 1.0, default=0.6, space="buy", optimize=True, decimals=2)
    
    use_drawdown_sizing = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    drawdown_threshold = DecimalParameter(0.05, 0.30, default=0.14, space="buy", optimize=True, decimals=2)
    drawdown_reduction = DecimalParameter(0.3, 0.8, default=0.61, space="buy", optimize=True, decimals=2)
    ...
    rebalance_threshold = DecimalParameter(0.20, 0.50, default=0.44, space="buy", optimize=True, decimals=2)
    max_position_pct = DecimalParameter(0.15, 0.40, default=0.34, space="buy", optimize=True, decimals=2)
    ...
    initial_safety_order_trigger = DecimalParameter(-0.5, 0.0, decimals=3, default=-0.146, space="buy", optimize=True)
    ...
    volume_spike_threshold = DecimalParameter(0.7, 3.0, decimals=1, default=1.75, space="buy", optimize=True)
    ...
    leverage_value = CategoricalParameter([1, 2, 3], default=4, space="buy", optimize=True)

    use_min_volume_filter = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    min_volume_filter = CategoricalParameter([5_000, 10_000, 20_000, 50_000, 75_000, 100_000, 150_000, 200_000, 300_000, 400_000, 500_000, 750_000, 1_000_000], default=400000, space="buy", optimize=True)
    ...
    total2es_vwap_size = CategoricalParameter([2, 3, 7, 14, 21, 28, 35, 42, 49, 56], default=7, space="buy", optimize=True)
    total2es_vwap_band_std = DecimalParameter(1.0, 1.10, default=1.02, decimals=3, space="sell", optimize=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['trend_WMA_2_3_0.5'] = clean_ta.trend.wma_indicator(close=dataframe['close'], window=3)
        dataframe['over_TRIX_24_21_4'] = TRIX(dataframe, length=24, power=21, MAtype=4)['TRIX_HISTO']
        dataframe['volatility_SMA_13_9_0.6'] = clean_ta.trend.sma_indicator(close=dataframe['close'], window=70)
        return dataframe

    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        conditions.append((dataframe['trend_WMA_2_3_0.5'] < dataframe['close']))
        conditions.append(((dataframe['over_TRIX_24_21_4'] > 0) & (dataframe['over_TRIX_24_21_4'] > dataframe['over_TRIX_24_21_4'].shift(5))))
        conditions.append((dataframe['volatility_SMA_13_9_0.6'].diff(periods=1) > 0))
        ...
        conditions.append((atr_pct < 0.061))
        if conditions:
            dataframe.loc[
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(((dataframe['over_TRIX_24_21_4'] > 0) & (dataframe['over_TRIX_24_21_4'] < dataframe['over_TRIX_24_21_4'].shift(60))))
        conditions.append(((dataframe['volatility_SMA_13_9_0.6'] < dataframe['volatility_SMA_13_9_0.6'].shift(3)) & (dataframe['volatility_SMA_13_9_0.6'] > dataframe['close'])))
        if conditions:
...
strategy_generator_json = {
    ...
    "params": {
        ...
        "buy": {
            ...
            "volatility_buy_conditions": 3,
            "volatility_buy_value": "p1",
            "volatility_indicator": "SMA",
            "volatility_max_filter_stake": 0.265,
            "volatility_size": 35,
            "volatility_size1": "p13",
            "volatility_size2": "p9",
            "volatility_size3": "p10",
            "volatility_size_stake": 25,
            "volatility_threshold": 0.061,
            "volume_rolling": 24,
            "volume_spike_threshold": 1.75,
            "volume_spike_window": 20,
            "volume_stake_max_ratio": 0.6,
            "volume_stake_max_threshold": 10000000,
            "volume_stake_min_ratio": 0.54,
        ...
        "sell": {
            ...
            "max_hold_hours": 200,
            "my_custom_stoploss": -0.7,
            "over_sell_conditions": 4,
            "over_sell_value": "p9",
            "over_use_sell": true,
            "parabolic_gain_threshold": 0.37,
            "parabolic_lookback": 10,
            "partial_profit_levels": 3,
            "partial_profit_pct_1": 0.3,
            "partial_profit_pct_2": 0.745,
            "partial_profit_pct_3": 1.302,
            "partial_profit_pct_4": 0.146,
            "profit_ratio_needed": -0.039,
            "total2es_vwap_band_std": 1.02,
            "trend_sell_conditions": 9,
            "trend_sell_value": "p8",
            ...
            "volatility_sell_value": "p2",
            "volatility_use_sell": true
        },
        "protection": {}
    },
    "ft_stratparam_v": 1,
    "export_time": "2025-09-02 19:59:36.275472+00:00"
}
"""
