...
#command = freqtrade backtesting --strategy generated_strategy82_v1 --config backtest_configs/futures_100_hyperliquid.json --timerange 20240101- --timeframe 1h --max-open-trades 4 --cache none --dry-run-wallet 1000

def lerp(a: float, b: float, t: float) -> float:
    return (1 - t) * a + t * b

class generated_strategy82_v1(IStrategy):    
    ...
    profit_ratio_needed = DecimalParameter(-0.100, 0.200, decimals=3, default=0.171, space="sell", optimize=True)
    ...
    my_custom_stoploss = DecimalParameter(-0.9, -0.1, decimals=1, default=-0.58, space="sell", optimize=True)
    ...
    partial_profit_pct_1 = DecimalParameter(0.005, 0.50, default=0.384, space="sell", optimize=True, decimals=3)
    partial_profit_pct_2 = DecimalParameter(0.01, 1.00, default=0.731, space="sell", optimize=True, decimals=3)
    partial_profit_pct_3 = DecimalParameter(0.02, 1.50, default=1.238, space="sell", optimize=True, decimals=3)
    partial_profit_pct_4 = DecimalParameter(0.05, 2.00, default=0.598, space="sell", optimize=True, decimals=3)
    ...
    parabolic_gain_threshold = DecimalParameter(0.10, 0.50, default=0.47, space="sell", optimize=True, decimals=2)
    ...
    max_daily_loss_pct = DecimalParameter(0.01, 0.10, default=0.086, space="buy", optimize=True, decimals=3)
    ...
    trailing_buy_pct = DecimalParameter(0.001, 0.10, default=0.087, space="buy", optimize=True, decimals=3)
    trailing_buy_max_distance = DecimalParameter(0.01, 0.20, default=0.03, space="buy", optimize=True, decimals=3)
    ...
    walcl_size = CategoricalParameter([7, 14, 50, 72, 100, 200, 300, 45, 46], default=300, space="buy", optimize=True)
    ...
    volume_stake_min_ratio = DecimalParameter(0.5, 1.0, default=0.74, space="buy", optimize=True, decimals=2)
    volume_stake_max_ratio = DecimalParameter(0.5, 1.0, default=0.59, space="buy", optimize=True, decimals=2)
    ...
    drawdown_reduction = DecimalParameter(0.3, 0.8, default=0.66, space="buy", optimize=True, decimals=2)
    ...
    rebalance_threshold = DecimalParameter(0.20, 0.50, default=0.41, space="buy", optimize=True, decimals=2)
    max_position_pct = DecimalParameter(0.15, 0.40, default=0.37, space="buy", optimize=True, decimals=2)
    ...
    initial_safety_order_trigger = DecimalParameter(-0.5, 0.0, decimals=3, default=0.011, space="buy", optimize=True)
    ...
    volume_spike_threshold = DecimalParameter(0.7, 3.0, decimals=1, default=2.5, space="buy", optimize=True)
    ...
    safety_order_step_scale = IntParameter(1, 20, default=3, space="buy", optimize=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['trend_ROC_8_6_7'] = clean_ta.momentum.ROCIndicator(close=dataframe['close'], window=48).roc()
        dataframe['over_SMA_1_6_1.0'] = clean_ta.trend.sma_indicator(close=dataframe['close'], window=6)
        dataframe['volatility_RET_45_6_1'] = dataframe['low'].rolling(45).min() + ((dataframe['high'].rolling(45).max() - dataframe['low'].rolling(45).min()) / 2)
        return dataframe

    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        conditions.append(((dataframe['over_SMA_1_6_1.0'] > dataframe['over_SMA_1_6_1.0'].shift(15)) & (dataframe['over_SMA_1_6_1.0'] > dataframe['close'])))
        conditions.append(((dataframe['volatility_RET_45_6_1'] < dataframe['close']) & (dataframe['volatility_RET_45_6_1'] > dataframe['volatility_RET_45_6_1'].shift(5))))
        if conditions:
            dataframe.loc[
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        conditions.append(((dataframe['trend_ROC_8_6_7'] < 40)))
        conditions.append(((dataframe['over_SMA_1_6_1.0'] < dataframe['over_SMA_1_6_1.0'].shift(3)) & (dataframe['over_SMA_1_6_1.0'] < dataframe['close'])))
        if conditions:
...
strategy_generator_json = {
    ...
    "params": {
        ...
        "buy": {
            ...
            "initial_safety_order_trigger": 0.011,
            "leverage_value": 2,
            "max_daily_loss_pct": 0.086,
            "max_position_pct": 0.37,
            "max_so_multiplier_orig": 3,
            "min_volume_filter": 200000,
            "need_cumulative_entry_call": true,
            "over_buy_conditions": 7,
            "over_buy_value": "p5",
            "over_indicator": "SMA",
            "over_size1": "p1",
            "over_size2": "p6",
        ...
        "sell": {
            ...
            "max_hold_hours": 1250,
            "my_custom_stoploss": -0.58,
            "over_sell_conditions": 9,
            "over_sell_value": "p2",
            "over_use_sell": true,
            "parabolic_gain_threshold": 0.47,
            "parabolic_lookback": 5,
            "partial_profit_levels": 2,
            "partial_profit_pct_1": 0.384,
            "partial_profit_pct_2": 0.731,
            "partial_profit_pct_3": 1.238,
            "partial_profit_pct_4": 0.598,
            "profit_ratio_needed": 0.171,
            "trend_sell_conditions": 5,
            "trend_sell_value": "p8",
            "trend_use_sell": true,
    ...
    "ft_stratparam_v": 1,
    "export_time": "2025-09-11 01:39:36.041737+00:00"
}
"""
