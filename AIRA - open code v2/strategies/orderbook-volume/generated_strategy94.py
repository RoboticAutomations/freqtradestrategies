...
#command = freqtrade backtesting --strategy generated_strategy94_v1 --config backtest_configs/futures_binance.json --timerange 20230101- --timeframe 1h --max-open-trades 3 --cache none --dry-run-wallet 1000

def lerp(a: float, b: float, t: float) -> float:
    return (1 - t) * a + t * b

class generated_strategy94_v1(IStrategy):    
    ...
    profit_ratio_needed = DecimalParameter(-0.100, 0.200, decimals=3, default=0.065, space="sell", optimize=True)
    ...
    my_custom_stoploss = DecimalParameter(-0.9, -0.1, decimals=1, default=-0.54, space="sell", optimize=True)
    ...
    partial_profit_pct_1 = DecimalParameter(0.005, 0.50, default=0.475, space="sell", optimize=True, decimals=3)
    partial_profit_pct_2 = DecimalParameter(0.01, 1.00, default=0.435, space="sell", optimize=True, decimals=3)
    partial_profit_pct_3 = DecimalParameter(0.02, 1.50, default=0.69, space="sell", optimize=True, decimals=3)
    partial_profit_pct_4 = DecimalParameter(0.05, 2.00, default=1.947, space="sell", optimize=True, decimals=3)
    ...
    parabolic_gain_threshold = DecimalParameter(0.10, 0.50, default=0.45, space="sell", optimize=True, decimals=2)
    ...
    max_daily_loss_pct = DecimalParameter(0.01, 0.10, default=0.048, space="buy", optimize=True, decimals=3)
    ...
    trailing_buy_pct = DecimalParameter(0.001, 0.10, default=0.06, space="buy", optimize=True, decimals=3)
    trailing_buy_max_distance = DecimalParameter(0.01, 0.20, default=0.124, space="buy", optimize=True, decimals=3)
    ...
    overbuy_factor = CategoricalParameter([0.8, 0.9, 0.995, 1.0], default=0.995, space="buy", optimize=True)
    ...
    walcl_ema_size = CategoricalParameter([14,42,72,84,126,168,212,256,300,400,500], default=14, space="buy", optimize=True)
    ...
    volatility_max_filter_stake = DecimalParameter(0.01, 0.30, default=0.08, space="buy", optimize=True, decimals=3)
    
    use_volume_stake = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    volume_stake_min_threshold = CategoricalParameter([10_000, 50_000, 100_000, 200_000, 300_000, 400_000, 500_000, 600_000, 700_000, 800_000, 1_000_000, 1_500_000], default=100000, space="buy", optimize=True)
    volume_stake_max_threshold = CategoricalParameter([25_000, 50_000, 75_000, 100_000, 250_000, 500_000, 750_000, 1_000_000, 1_500_000, 2_000_000, 3_000_000, 5_000_000, 7_500_000, 10_000_000], default=25000, space="buy", optimize=True)
    volume_stake_min_ratio = DecimalParameter(0.5, 1.0, default=0.93, space="buy", optimize=True, decimals=2)
    volume_stake_max_ratio = DecimalParameter(0.5, 1.0, default=1.0, space="buy", optimize=True, decimals=2)
    
    use_drawdown_sizing = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    drawdown_threshold = DecimalParameter(0.05, 0.30, default=0.23, space="buy", optimize=True, decimals=2)
    drawdown_reduction = DecimalParameter(0.3, 0.8, default=0.71, space="buy", optimize=True, decimals=2)
    ...
    max_position_pct = DecimalParameter(0.15, 0.40, default=0.32, space="buy", optimize=True, decimals=2)
    ...
    volume_spike_window = IntParameter(3, 50, default=30, space="buy", optimize=True)
    ...
    safety_order_step_scale = IntParameter(1, 20, default=12, space="buy", optimize=True)
    ...
    partial_fill_compensation_scale = DecimalParameter(0.4, 1, decimals=1, default=0.6, space="buy", optimize=True)
    ...
    min_volume_filter = CategoricalParameter([5_000, 10_000, 20_000, 50_000, 75_000, 100_000, 150_000, 200_000, 300_000, 400_000, 500_000, 750_000, 1_000_000], default=20000, space="buy", optimize=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['over_ATL_3.0_8_100_1'] = dataframe['low'].rolling(int(24)).min()
        dataframe['over_ATL_3.0_8_100_2'] = dataframe['low'].rolling(int(300)).min()
        dataframe['volatility_ATH_2.25_60_75_1'] = dataframe['high'].rolling(int(135)).max()
        dataframe['volatility_ATH_2.25_60_75_2'] = dataframe['high'].rolling(int(168)).max()
        return dataframe

    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        conditions.append(( dataframe['over_ATL_3.0_8_100_2'].shift(15) < dataframe['over_ATL_3.0_8_100_1'] ))
        conditions.append(( dataframe['volatility_ATH_2.25_60_75_1'].shift(8) >= dataframe['volatility_ATH_2.25_60_75_1'] ))
        ...
        conditions.append((atr_pct < 0.075))
        if conditions:
            dataframe.loc[
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        conditions.append(( dataframe['over_ATL_3.0_8_100_1'].shift(30) > dataframe['low'] ))
        conditions.append(( dataframe['volatility_ATH_2.25_60_75_1'].shift(30) <= dataframe['volatility_ATH_2.25_60_75_1'] ))
        if conditions:
...
strategy_generator_json = {
    ...
    "params": {
        ...
        "buy": {
            ...
            "drawdown_reduction": 0.71,
            "drawdown_threshold": 0.23,
            ...
            "volatility_buy_conditions": 2,
            "volatility_buy_value": "p4",
            "volatility_indicator": "ATH",
            "volatility_max_filter_stake": 0.08,
            "volatility_size": 6,
            "volatility_size1": "p14",
            "volatility_size2": "p10",
            "volatility_size3": "p11",
            "volatility_size_stake": 8,
            "volatility_threshold": 0.075,
            "volume_rolling": 72,
            "volume_spike_threshold": 1.25,
            "volume_spike_window": 30,
            "volume_stake_max_ratio": 1.0,
            "volume_stake_max_threshold": 25000,
            "volume_stake_min_ratio": 0.93,
            "volume_stake_min_threshold": 100000,
        ...
        "sell": {
            ...
            "max_hold_hours": 1250,
            "my_custom_stoploss": -0.54,
            "over_sell_conditions": 10,
            "over_sell_value": "p7",
            "over_use_sell": true,
            "parabolic_gain_threshold": 0.45,
            "parabolic_lookback": 3,
            "partial_profit_levels": 4,
            "partial_profit_pct_1": 0.475,
            "partial_profit_pct_2": 0.435,
            "partial_profit_pct_3": 0.69,
            "partial_profit_pct_4": 1.947,
            "profit_ratio_needed": 0.065,
            "trend_sell_conditions": 1,
            "trend_sell_value": "p8",
    ...
    "ft_stratparam_v": 1,
    "export_time": "2025-09-14 19:41:11.912148+00:00"
}
"""
