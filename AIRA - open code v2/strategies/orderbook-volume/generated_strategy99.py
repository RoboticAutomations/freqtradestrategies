...
#   max positions = 3
#   timeframe = 1h
#   config = backtest_configs/futures_hyperliquid.json
#   timerange = 20240101-
#   hyperoptloss = Mouton2HyperOptLoss
#   spaces = buy sell

#command = freqtrade backtesting --strategy generated_strategy99_v1 --config backtest_configs/futures_hyperliquid.json --timerange 20240101- --timeframe 1h --max-open-trades 3 --cache none --dry-run-wallet 1000

def lerp(a: float, b: float, t: float) -> float:
    return (1 - t) * a + t * b

class generated_strategy99_v1(IStrategy):    
    ...
    profit_ratio_needed = DecimalParameter(-0.100, 0.200, decimals=3, default=0.13, space="sell", optimize=True)
    exit_only_profit = BooleanParameter(default=True, space="sell", optimize=True)
    max_hold_hours = CategoricalParameter([8, 16, 24, 48, 72, 96, 120, 150, 200, 250, 300, 350, 400, 450, 500, 750, 1000, 1250, 1500], default=750, space="sell", optimize=True)
    ...
    my_custom_stoploss = DecimalParameter(-0.9, -0.1, decimals=1, default=-0.52, space="sell", optimize=True)
    
    use_partial_profit = CategoricalParameter([True, False], default=True, space="sell", optimize=True)
    partial_profit_levels = CategoricalParameter([2, 3, 4], default=2, space="sell", optimize=True)
    partial_profit_pct_1 = DecimalParameter(0.005, 0.50, default=0.481, space="sell", optimize=True, decimals=3)
    partial_profit_pct_2 = DecimalParameter(0.01, 1.00, default=0.311, space="sell", optimize=True, decimals=3)
    partial_profit_pct_3 = DecimalParameter(0.02, 1.50, default=0.78, space="sell", optimize=True, decimals=3)
    partial_profit_pct_4 = DecimalParameter(0.05, 2.00, default=1.901, space="sell", optimize=True, decimals=3)
    
    use_parabolic_exit = CategoricalParameter([True, False], default=True, space="sell", optimize=True)
    parabolic_lookback = CategoricalParameter([3, 5, 7, 10, 15], default=15, space="sell", optimize=True)
    parabolic_gain_threshold = DecimalParameter(0.10, 0.50, default=0.48, space="sell", optimize=True, decimals=2)
    ...
    trading_time_mode = CategoricalParameter(["always", "weekdays_only", "weekend_only"], default="weekdays_only", space="buy", optimize=True)
    
    use_max_daily_loss = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    max_daily_loss_pct = DecimalParameter(0.01, 0.10, default=0.044, space="buy", optimize=True, decimals=3)
    
    entry_mode = CategoricalParameter(["none", "entry_scaling", "trailing_buy"], default="entry_scaling", space="buy", optimize=True)
    ...
    trailing_buy_pct = DecimalParameter(0.001, 0.10, default=0.092, space="buy", optimize=True, decimals=3)
    trailing_buy_max_distance = DecimalParameter(0.01, 0.20, default=0.091, space="buy", optimize=True, decimals=3)
    trailing_buy_max_hours = CategoricalParameter([1, 2, 4, 8, 12, 24, 48], default=1, space="buy", optimize=True)
    ...
    overbuy_factor = CategoricalParameter([0.8, 0.9, 0.995, 1.0], default=1.0, space="buy", optimize=True)
    
    use_volatility_stake = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    volatility_size = CategoricalParameter([4,6,8,10,12,14,16,20, 25, 30, 35, 40], default=16, space="buy", optimize=True)
    volatility_max_filter = DecimalParameter(0.01, 0.12, default=0.03, space="buy", optimize=True, decimals=3)
    
    use_walcl_stake = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    walcl_size = CategoricalParameter([7, 14, 50, 72, 100, 200, 300, 45, 46], default=14, space="buy", optimize=True)
    walcl_ema_size = CategoricalParameter([14,42,72,84,126,168,212,256,300,400,500], default=168, space="buy", optimize=True)
    walcl_stake_mode = CategoricalParameter([1,2,3,4,5,6], default=2, space="buy", optimize=True)
    walcl_adjustment = CategoricalParameter([0.25, 0.5, 0.75], default=0.25, space="buy", optimize=True)
    
    volatility_size_stake = CategoricalParameter([4, 6, 8, 10, 12, 14, 16, 20, 25], default=8, space="buy", optimize=True)
    volatility_max_filter_stake = DecimalParameter(0.01, 0.30, default=0.241, space="buy", optimize=True, decimals=3)
    
    use_volume_stake = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    volume_stake_min_threshold = CategoricalParameter([10_000, 50_000, 100_000, 200_000, 300_000, 400_000, 500_000, 600_000, 700_000, 800_000, 1_000_000, 1_500_000], default=500000, space="buy", optimize=True)
    ...
    volume_stake_min_ratio = DecimalParameter(0.5, 1.0, default=0.95, space="buy", optimize=True, decimals=2)
    volume_stake_max_ratio = DecimalParameter(0.5, 1.0, default=0.61, space="buy", optimize=True, decimals=2)
    
    use_drawdown_sizing = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    drawdown_threshold = DecimalParameter(0.05, 0.30, default=0.29, space="buy", optimize=True, decimals=2)
    drawdown_reduction = DecimalParameter(0.3, 0.8, default=0.76, space="buy", optimize=True, decimals=2)
    drawdown_lookback = CategoricalParameter([10, 20, 30, 50], default=10, space="buy", optimize=True)
    
    use_portfolio_rebalancing = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    rebalance_threshold = DecimalParameter(0.20, 0.50, default=0.36, space="buy", optimize=True, decimals=2)
    max_position_pct = DecimalParameter(0.15, 0.40, default=0.3, space="buy", optimize=True, decimals=2)
    ...
    tradable_balance_ratio = CategoricalParameter([0.25, 0.35, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.1], default=0.6, space="buy", optimize=True)
    ...
    initial_safety_order_trigger = DecimalParameter(-0.5, 0.0, decimals=3, default=0.148, space="buy", optimize=True)
    ...
    adjust_need_entry_signal = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    ...
    volume_spike_window = IntParameter(3, 50, default=50, space="buy", optimize=True)
    ...
    volume_spike_threshold = DecimalParameter(0.7, 3.0, decimals=1, default=2.0, space="buy", optimize=True)
    ...
    safety_order_step_scale = IntParameter(1, 20, default=8, space="buy", optimize=True)
    ...
    partial_fill_compensation_scale = DecimalParameter(0.4, 1, decimals=1, default=0.4, space="buy", optimize=True)
    
    use_time_based_dca = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    time_based_dca_candles = CategoricalParameter([1, 2, 4, 8, 12, 24, 48], default=12, space="buy", optimize=True)
    ...
    max_so_multiplier_orig = IntParameter(1, 10, default=2, space="buy", optimize=True)
    ...
    safety_order_volume_scale = DecimalParameter(0.5, 9.0, decimals=1, default=2.0, space="buy", optimize=True)
    ...
    leverage_value = CategoricalParameter([1, 2, 3], default=3, space="buy", optimize=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # MM20 - Moving Average 20 based
        wma1 = clean_ta.trend.wma_indicator(close=dataframe['close'], window=10//2)
        wma2 = clean_ta.trend.wma_indicator(close=dataframe['close'], window=10)
        ma_base = clean_ta.trend.wma_indicator(close=2*wma1-wma2, window=int(np.sqrt(10)))
        dataframe['trend_MM20_0.5_4_7'] = ma_base
        dataframe['trend_MM20_0.5_4_7'] = dataframe['trend_MM20_0.5_4_7'].rolling(7).mean()
        dataframe['trend_MM20_0.5_4_7_slope'] = dataframe['trend_MM20_0.5_4_7'].pct_change(5) * 100
        dataframe['trend_MM20_0.5_4_7_distance'] = ((dataframe['close'] / dataframe['trend_MM20_0.5_4_7']) - 1) * 100
        dataframe['trend_MM20_0.5_4_7_volatility'] = dataframe['trend_MM20_0.5_4_7_distance'].rolling(10//4).std()
        dataframe['trend_MM20_0.5_4_7_bullish'] = ((dataframe['close'] > dataframe['trend_MM20_0.5_4_7']) & (dataframe['trend_MM20_0.5_4_7_slope'] > 0))
        dataframe['trend_MM20_0.5_4_7_bearish'] = ((dataframe['close'] < dataframe['trend_MM20_0.5_4_7']) & (dataframe['trend_MM20_0.5_4_7_slope'] < 0))
        dataframe['over_TRIX_12_24_4'] = TRIX(dataframe, length=12, power=24, MAtype=4)['TRIX_HISTO']
        dataframe['volatility_AWESOME_13_200_3'] = clean_ta.momentum.AwesomeOscillatorIndicator(high=dataframe['high'], low=dataframe['low'], window1=39, window2=200).awesome_oscillator()
        return dataframe

    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        conditions.append((dataframe['trend_MM20_0.5_4_7_slope'] > 0.3))
        conditions.append(((dataframe['volatility_AWESOME_13_200_3'] > 0) & (dataframe['volatility_AWESOME_13_200_3'].shift(1) <= 0)))
        ...
        conditions.append((atr_pct < 0.078))
        if conditions:
            dataframe.loc[
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        conditions.append(((dataframe['over_TRIX_12_24_4'] > 0) & (dataframe['over_TRIX_12_24_4'] < dataframe['over_TRIX_12_24_4'].shift(60))))
        if conditions:
...
strategy_generator_json = {
    ...
    "params": {
        ...
        "buy": {
            ...
            "over_size3": "p11",
            "overbuy_factor": 1.0,
            "partial_fill_compensation_scale": 0.4,
            "rebalance_threshold": 0.36,
            "safety_order_step_scale": 8,
            "safety_order_volume_scale": 2.0,
            "time_based_dca_candles": 12,
            "tradable_balance_ratio": 0.6,
            "trading_time_mode": "weekdays_only",
            "trailing_buy_max_distance": 0.091,
            "trailing_buy_max_hours": 1,
            "trailing_buy_pct": 0.092,
            "trend_buy_conditions": 2,
            "trend_buy_value": "p3",
            "trend_indicator": "MM20",
            "trend_size1": "p1",
            "trend_size2": "p14",
            "trend_size3": "p7",
            ...
            "use_portfolio_rebalancing": false,
            ...
            "volatility_buy_conditions": 1,
            "volatility_buy_value": "p1",
            "volatility_indicator": "AWESOME",
            "volatility_max_filter_stake": 0.241,
            "volatility_size": 16,
            "volatility_size1": "p13",
            "volatility_size2": "p13",
            "volatility_size3": "p3",
            "volatility_size_stake": 8,
            "volatility_threshold": 0.078,
            "volume_rolling": 96,
            "volume_spike_threshold": 2.0,
            "volume_spike_window": 50,
            "volume_stake_max_ratio": 0.61,
            "volume_stake_max_threshold": 1500000,
            "volume_stake_min_ratio": 0.95,
            "volume_stake_min_threshold": 500000,
        ...
        "sell": {
            ...
            "max_hold_hours": 750,
            "my_custom_stoploss": -0.52,
            "over_sell_conditions": 4,
            "over_sell_value": "p9",
            "over_use_sell": true,
            "parabolic_gain_threshold": 0.48,
            "parabolic_lookback": 15,
            "partial_profit_levels": 2,
            "partial_profit_pct_1": 0.481,
            "partial_profit_pct_2": 0.311,
            "partial_profit_pct_3": 0.78,
            "partial_profit_pct_4": 1.901,
            "profit_ratio_needed": 0.13,
            "trend_sell_conditions": 6,
            "trend_sell_value": "p4",
            "trend_use_sell": false,
            "use_parabolic_exit": true,
            "use_partial_profit": true,
            "volatility_sell_conditions": 6,
            "volatility_sell_value": "p7",
            "volatility_use_sell": false
        },
        "protection": {}
    },
    "ft_stratparam_v": 1,
    "export_time": "2025-09-16 14:42:32.622146+00:00"
}
"""
