...
#command = freqtrade backtesting --strategy generated_strategy84_v1 --config backtest_configs/futures_100_hyperliquid.json --timerange 20240101- --timeframe 1h --max-open-trades 4 --cache none --dry-run-wallet 1000

def lerp(a: float, b: float, t: float) -> float:
    return (1 - t) * a + t * b

class generated_strategy84_v1(IStrategy):    
    ...
    profit_ratio_needed = DecimalParameter(-0.100, 0.200, decimals=3, default=0.289, space="sell", optimize=True)
    exit_only_profit = BooleanParameter(default=True, space="sell", optimize=True)
    max_hold_hours = CategoricalParameter([8, 16, 24, 48, 72, 96, 120, 150, 200, 250, 300, 350, 400, 450, 500, 750, 1000, 1250, 1500], default=48, space="sell", optimize=True)
    ...
    my_custom_stoploss = DecimalParameter(-0.9, -0.1, decimals=1, default=-0.2, space="sell", optimize=True)
    ...
    partial_profit_pct_1 = DecimalParameter(0.005, 0.50, default=0.439, space="sell", optimize=True, decimals=3)
    partial_profit_pct_2 = DecimalParameter(0.01, 1.00, default=0.228, space="sell", optimize=True, decimals=3)
    partial_profit_pct_3 = DecimalParameter(0.02, 1.50, default=0.873, space="sell", optimize=True, decimals=3)
    partial_profit_pct_4 = DecimalParameter(0.05, 2.00, default=0.429, space="sell", optimize=True, decimals=3)
    ...
    parabolic_gain_threshold = DecimalParameter(0.10, 0.50, default=0.38, space="sell", optimize=True, decimals=2)
    ...
    max_daily_loss_pct = DecimalParameter(0.01, 0.10, default=0.026, space="buy", optimize=True, decimals=3)
    ...
    trailing_buy_pct = DecimalParameter(0.001, 0.10, default=0.014, space="buy", optimize=True, decimals=3)
    trailing_buy_max_distance = DecimalParameter(0.01, 0.20, default=0.098, space="buy", optimize=True, decimals=3)
    ...
    walcl_ema_size = CategoricalParameter([14,42,72,84,126,168,212,256,300,400,500], default=400, space="buy", optimize=True)
    walcl_stake_mode = CategoricalParameter([1,2,3,4,5,6], default=3, space="buy", optimize=True)
    ...
    volatility_max_filter_stake = DecimalParameter(0.01, 0.30, default=0.287, space="buy", optimize=True, decimals=3)
    ...
    volume_stake_max_threshold = CategoricalParameter([25_000, 50_000, 75_000, 100_000, 250_000, 500_000, 750_000, 1_000_000, 1_500_000, 2_000_000, 3_000_000, 5_000_000, 7_500_000, 10_000_000], default=250000, space="buy", optimize=True)
    volume_stake_min_ratio = DecimalParameter(0.5, 1.0, default=0.89, space="buy", optimize=True, decimals=2)
    volume_stake_max_ratio = DecimalParameter(0.5, 1.0, default=0.82, space="buy", optimize=True, decimals=2)
    ...
    drawdown_reduction = DecimalParameter(0.3, 0.8, default=0.72, space="buy", optimize=True, decimals=2)
    ...
    rebalance_threshold = DecimalParameter(0.20, 0.50, default=0.34, space="buy", optimize=True, decimals=2)
    ...
    initial_safety_order_trigger = DecimalParameter(-0.5, 0.0, decimals=3, default=-0.102, space="buy", optimize=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['over_EMA_4_11_1.0'] = clean_ta.trend.ema_indicator(close=dataframe['close'], window=44)
        dataframe["volatility_VWAP_13_8_2.0"] = clean_ta.volume.VolumeWeightedAveragePrice(dataframe["high"], dataframe["low"], dataframe["close"], dataframe["volume"], window=int(26)).volume_weighted_average_price()
        return dataframe

    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        conditions.append((dataframe['over_EMA_4_11_1.0'].diff(periods=75) > 0))
        if conditions:
            dataframe.loc[
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        conditions.append((dataframe['volatility_VWAP_13_8_2.0'].shift(5) >= dataframe['close']))
        if conditions:
...
strategy_generator_json = {
    ...
    "params": {
        ...
        "buy": {
            ...
            "trailing_buy_max_distance": 0.098,
            "trailing_buy_max_hours": 12,
            "trailing_buy_pct": 0.014,
            ...
            "volatility_max_filter_stake": 0.287,
            "volatility_size": 6,
            "volatility_size1": "p13",
            "volatility_size2": "p8",
            "volatility_size3": "p3",
            "volatility_size_stake": 4,
            "volatility_threshold": 0.073,
            "volume_rolling": 24,
            "volume_spike_threshold": 3.0,
            "volume_spike_window": 2,
            "volume_stake_max_ratio": 0.82,
            "volume_stake_max_threshold": 250000,
        ...
        "sell": {
            ...
            "max_hold_hours": 48,
            "my_custom_stoploss": -0.2,
            "over_sell_conditions": 5,
            "over_sell_value": "p3",
            "over_use_sell": false,
            "parabolic_gain_threshold": 0.38,
            "parabolic_lookback": 15,
            "partial_profit_levels": 4,
            "partial_profit_pct_1": 0.439,
            "partial_profit_pct_2": 0.228,
            "partial_profit_pct_3": 0.873,
            "partial_profit_pct_4": 0.429,
            "profit_ratio_needed": 0.289,
            ...
            "volatility_sell_value": "p3",
            "volatility_use_sell": true
        },
        "protection": {}
    },
    "ft_stratparam_v": 1,
    "export_time": "2025-09-11 14:50:34.678288+00:00"
}
"""
