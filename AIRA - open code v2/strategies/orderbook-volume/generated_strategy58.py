...
#command = freqtrade backtesting --strategy generated_strategy58_v1 --config backtest_configs/futures_hyperliquid.json --timerange 20240101- --timeframe 2h --max-open-trades 15 --cache none --dry-run-wallet 1000

def lerp(a: float, b: float, t: float) -> float:
    return (1 - t) * a + t * b

class generated_strategy58_v1(IStrategy):    
