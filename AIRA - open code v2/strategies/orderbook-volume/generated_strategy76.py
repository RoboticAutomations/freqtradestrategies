...
#command = freqtrade backtesting --strategy generated_strategy76_v1 --config backtest_configs/futures_100_hyperliquid.json --timerange 20240101- --timeframe 1h --max-open-trades 4 --cache none --dry-run-wallet 1000

def lerp(a: float, b: float, t: float) -> float:
    return (1 - t) * a + t * b

class generated_strategy76_v1(IStrategy):    
    ...
    profit_ratio_needed = DecimalParameter(-0.100, 0.200, decimals=3, default=-0.091, space="sell", optimize=True)
    exit_only_profit = BooleanParameter(default=True, space="sell", optimize=True)
    max_hold_hours = CategoricalParameter([8, 16, 24, 48, 72, 96, 120, 150, 200, 250, 300, 350, 400, 450, 500, 750, 1000, 1250, 1500], default=150, space="sell", optimize=True)
    ...
    my_custom_stoploss = DecimalParameter(-0.9, -0.1, decimals=1, default=-0.1, space="sell", optimize=True)
    ...
    partial_profit_pct_1 = DecimalParameter(0.005, 0.50, default=0.445, space="sell", optimize=True, decimals=3)
    partial_profit_pct_2 = DecimalParameter(0.01, 1.00, default=0.474, space="sell", optimize=True, decimals=3)
    partial_profit_pct_3 = DecimalParameter(0.02, 1.50, default=0.093, space="sell", optimize=True, decimals=3)
    partial_profit_pct_4 = DecimalParameter(0.05, 2.00, default=0.547, space="sell", optimize=True, decimals=3)
    ...
    parabolic_gain_threshold = DecimalParameter(0.10, 0.50, default=0.5, space="sell", optimize=True, decimals=2)
    ...
    trailing_buy_pct = DecimalParameter(0.001, 0.10, default=0.079, space="buy", optimize=True, decimals=3)
    trailing_buy_max_distance = DecimalParameter(0.01, 0.20, default=0.103, space="buy", optimize=True, decimals=3)
    ...
    use_custom_stake = CategoricalParameter([True, False], default=True, space="buy", optimize=True)
    ...
    volatility_size_stake = CategoricalParameter([4, 6, 8, 10, 12, 14, 16, 20, 25], default=16, space="buy", optimize=True)
    volatility_max_filter_stake = DecimalParameter(0.01, 0.30, default=0.042, space="buy", optimize=True, decimals=3)
    ...
    volume_stake_max_threshold = CategoricalParameter([25_000, 50_000, 75_000, 100_000, 250_000, 500_000, 750_000, 1_000_000, 1_500_000, 2_000_000, 3_000_000, 5_000_000, 7_500_000, 10_000_000], default=7500000, space="buy", optimize=True)
    volume_stake_min_ratio = DecimalParameter(0.5, 1.0, default=0.62, space="buy", optimize=True, decimals=2)
    volume_stake_max_ratio = DecimalParameter(0.5, 1.0, default=0.63, space="buy", optimize=True, decimals=2)
    
    use_drawdown_sizing = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    drawdown_threshold = DecimalParameter(0.05, 0.30, default=0.2, space="buy", optimize=True, decimals=2)
    drawdown_reduction = DecimalParameter(0.3, 0.8, default=0.62, space="buy", optimize=True, decimals=2)
    drawdown_lookback = CategoricalParameter([10, 20, 30, 50], default=30, space="buy", optimize=True)
    
    use_portfolio_rebalancing = CategoricalParameter([True, False], default=False, space="buy", optimize=True)
    rebalance_threshold = DecimalParameter(0.20, 0.50, default=0.38, space="buy", optimize=True, decimals=2)
    ...
    initial_safety_order_trigger = DecimalParameter(-0.5, 0.0, decimals=3, default=-0.052, space="buy", optimize=True)
    ...
    volume_spike_window = IntParameter(3, 50, default=4, space="buy", optimize=True)
    ...
    volume_spike_threshold = DecimalParameter(0.7, 3.0, decimals=1, default=1.5, space="buy", optimize=True)
    ...
    partial_fill_compensation_scale = DecimalParameter(0.4, 1, decimals=1, default=1.0, space="buy", optimize=True)
    ...
    min_volume_filter = CategoricalParameter([5_000, 10_000, 20_000, 50_000, 75_000, 100_000, 150_000, 200_000, 300_000, 400_000, 500_000, 750_000, 1_000_000], default=150000, space="buy", optimize=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        keltner = clean_ta.volatility.KeltnerChannel(high=dataframe['high'], low=dataframe['low'], close=dataframe['close'], window=2, window_atr=3.5)
        dataframe['trend_KELTNER_3_3.5_0.75_lband'] = keltner.keltner_channel_lband()
        dataframe['trend_KELTNER_3_3.5_0.75_mband'] = keltner.keltner_channel_mband()
        dataframe['trend_KELTNER_3_3.5_0.75_hband'] = keltner.keltner_channel_hband()
        dataframe["over_ATR_PERCENT_12_8_0.4"] = (ta.ATR(dataframe, timeperiod=96) / dataframe["close"]) * 100
        dataframe['volatility_ULTIMATE_6_3_200'] = clean_ta.momentum.UltimateOscillator(high=dataframe['high'],low=dataframe['low'],close=dataframe['close'],window1=6,window2=3,window3=200).ultimate_oscillator()
        return dataframe

    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        conditions.append((dataframe['close'] < dataframe['trend_KELTNER_3_3.5_0.75_mband']))
        conditions.append((dataframe['over_ATR_PERCENT_12_8_0.4'] > dataframe['over_ATR_PERCENT_12_8_0.4'].shift(25)))
        conditions.append(((dataframe['volatility_ULTIMATE_6_3_200'] > 60) & (dataframe['volatility_ULTIMATE_6_3_200'].shift(1) <= 60)))
        ...
        conditions.append((atr_pct < 0.031))
        if conditions:
            dataframe.loc[
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        conditions.append((dataframe['close'] < dataframe['trend_KELTNER_3_3.5_0.75_lband']))
        conditions.append(((dataframe['volatility_ULTIMATE_6_3_200'] > 10) & (dataframe['volatility_ULTIMATE_6_3_200'] < dataframe['volatility_ULTIMATE_6_3_200'].shift(1))))
        if conditions:
...
strategy_generator_json = {
    ...
    "params": {
        ...
        "buy": {
            ...
            "initial_safety_order_trigger": -0.052,
            "leverage_value": 5,
            ...
            "over_buy_conditions": 10,
            "over_buy_value": "p8",
            "over_indicator": "ATR_PERCENT",
            "over_size1": "p12",
            "over_size2": "p8",
            "over_size3": "p11",
            "overbuy_factor": 1.0,
            "partial_fill_compensation_scale": 1.0,
            "rebalance_threshold": 0.38,
            ...
            "trailing_buy_max_distance": 0.103,
            "trailing_buy_max_hours": 4,
            "trailing_buy_pct": 0.079,
            ...
            "volatility_buy_conditions": 9,
            "volatility_buy_value": "p7",
            "volatility_indicator": "ULTIMATE",
            "volatility_max_filter_stake": 0.042,
            "volatility_size": 16,
            "volatility_size1": "p2",
            "volatility_size2": "p1",
            "volatility_size3": "p14",
            "volatility_size_stake": 16,
            "volatility_threshold": 0.031,
            "volume_rolling": 96,
            "volume_spike_threshold": 1.5,
            "volume_spike_window": 4,
            "volume_stake_max_ratio": 0.63,
            "volume_stake_max_threshold": 7500000,
            "volume_stake_min_ratio": 0.62,
        ...
        "sell": {
            ...
            "max_hold_hours": 150,
            "my_custom_stoploss": -0.1,
            "over_sell_conditions": 5,
            "over_sell_value": "p7",
            "over_use_sell": false,
            "parabolic_gain_threshold": 0.5,
            "parabolic_lookback": 15,
            "partial_profit_levels": 4,
            "partial_profit_pct_1": 0.445,
            "partial_profit_pct_2": 0.474,
            "partial_profit_pct_3": 0.093,
            "partial_profit_pct_4": 0.547,
            "profit_ratio_needed": -0.091,
    ...
    "ft_stratparam_v": 1,
    "export_time": "2025-09-09 03:34:28.394633+00:00"
}
"""
