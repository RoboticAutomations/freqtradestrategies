...
class EI5_t4c0s(IStrategy):
    ...
    unclog1 = DecimalParameter(0.15, 0.2, default=0.19,  decimals=2, space='sell', optimize=True)
    unclog2 = DecimalParameter(0.11, 0.15, default=0.11,  decimals=2, space='sell', optimize=True)
    unclog3 = DecimalParameter(0.14, 0.18, default=0.14,  decimals=2, space='sell', optimize=True)
    unclog4 = DecimalParameter(0.14, 0.18, default=0.18,  decimals=2, space='sell', optimize=True)
    ...
    low_offset = DecimalParameter(0.975, 0.990, default=0.98, space='buy', optimize=True)
    high_offset = DecimalParameter(1.005, 1.015, default=1.004, space='sell', optimize=True)
    high_offset_2 = DecimalParameter(1.014, 1.020, default=1.016, space='sell', optimize=True)
