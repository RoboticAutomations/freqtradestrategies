...
class EI1_t4c0s_V4(IStrategy):
    ...
    fib0 = CategoricalParameter([0.618, 0.786, 1.00, 1.250, 1.382], default=1.250, space='buy', optimize=True)
    fib1 = CategoricalParameter([0.618, 0.786, 1.00, 1.250, 1.382], default=1.250, space='buy', optimize=True)
    fib4 = CategoricalParameter([0.618, 0.786, 1.00, 1.250, 1.382], default=1.250, space='buy', optimize=True)
    fib2 = CategoricalParameter([0.618, 0.786, 1.00, 1.250, 1.382], default=1.250, space='sell', optimize=True)
    fib3 = CategoricalParameter([0.618, 0.786, 1.00, 1.250, 1.382], default=1.250, space='sell', optimize=True)
