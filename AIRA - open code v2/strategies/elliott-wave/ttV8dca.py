...
class ttV8dca(IStrategy):
    ...
    # SMAOffset
    base_nb_candles_buy = IntParameter(5, 60, default=9, space='buy', optimize=True)
    base_nb_candles_sell = IntParameter(5, 60, default=24, space='sell', optimize=True)
    low_offset = DecimalParameter(0.95, 0.99, default=0.99, decimals=2, space='buy', optimize=True)
    high_offset = DecimalParameter(0.95, 1.1, default=1.05,  decimals=2, space='sell', optimize=True)
    high_offset_2 = DecimalParameter(0.99, 1.5, default=0.99, decimals=2, space='sell', optimize=True)   

    # Protection
    fast_ewo = 50
    slow_ewo = 200
    ewo_low = IntParameter(-5, 0, default=-9, space='buy', optimize=True)
    ewo_high = IntParameter(0, 2, default=2, space='buy', optimize=True)
    ewo_high_safe = IntParameter(2, 8, default=12, space='buy', optimize=True)
    ewo_high_uL = IntParameter(15, 25, default=21, space='buy', optimize=True)
    rsi_buy = IntParameter(55, 70, default=70, space='buy', optimize=True)
    ### BTC 
    bull = DecimalParameter(-0.25, 0.25, default=-0.25, space='buy',decimals=2, optimize=True)
    estop = DecimalParameter(-0.5, 0, default=-0.38, space='sell',decimals=2, optimize=True)
    ...
    tsl_target5 = DecimalParameter(low=0.3, high=0.4, default=0.3, decimals=1, space='sell', optimize=True, load=True)
    ts5 = DecimalParameter(low=0.04, high=0.06, default=0.057, space='sell', optimize=True, load=True)
    tsl_target4 = DecimalParameter(low=0.18, high=0.3, default=0.229, space='sell', optimize=True, load=True)
    ts4 = DecimalParameter(low=0.03, high=0.05, default=0.046, space='sell', optimize=True, load=True)
    tsl_target3 = DecimalParameter(low=0.12, high=0.18, default=0.13, space='sell', optimize=True, load=True)
    ts3 = DecimalParameter(low=0.025, high=0.04, default=0.04, space='sell', optimize=True, load=True)
    tsl_target2 = DecimalParameter(low=0.07, high=0.12, default=0.07, space='sell', optimize=True, load=True)
    ts2 = DecimalParameter(low=0.015, high=0.03, default=0.019, space='sell', optimize=True, load=True)
    tsl_target1 = DecimalParameter(low=0.04, high=0.07, default=0.049, space='sell', optimize=True, load=True)
    ts1 = DecimalParameter(low=0.01, high=0.016, default=0.011, space='sell', optimize=True, load=True)
    tsl_target0 = DecimalParameter(low=0.02, high=0.05, default=0.047, space='sell', optimize=True, load=True)
    ts0 = DecimalParameter(low=0.008, high=0.015, default=0.015, space='sell', optimize=True, load=True)
