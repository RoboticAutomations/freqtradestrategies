...
class EI4_t4c0s(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        lrc_1 = LinearRegressionChannel(dataframe, source = 'OHLC4', period = 150, deviations = 1.618)
        dataframe['lrc_s_up'] = lrc_1['lrc_up']
        dataframe['lrc_s_dn'] = lrc_1['lrc_down']
        dataframe['lrc_s_ang'] = lrc_1['angle_deg']
        dataframe['lrc_s_Pearsons_R'] = lrc_1['Pearsons_R']
