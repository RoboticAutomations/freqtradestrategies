...
class ARIMA_5_DCA(IStrategy):
    ...
    # DCA
    max_entry_position_adjustment = 3  # Number of ADDITIONAL entries
    ...
    def adjust_trade_position(self, trade: Trade, current_time: datetime, 
        ...
        try: 
            ...
            if count_of_entries == 1 and enable == 1:  
                ...
                stake_amount = stake_amount * 1.5 
            elif count_of_entries == 0 and enable == 1: 
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if current_time - self.last_run_time[pair] >= 1800:  # Check if an hour has passed
