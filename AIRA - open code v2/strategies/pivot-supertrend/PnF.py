...
class PnF(IStrategy):
    ...
    box_size = DecimalParameter(low=0.5, high=5.0, default=1.0, decimals=1 ,space='buy', optimize=True, load=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        rolling_window = dataframe['close'].rolling(12) 
        ...
        dataframe['cycle_move_mean'] = dataframe['cycle_move'].rolling(12).mean()  
