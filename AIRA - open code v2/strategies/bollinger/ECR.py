...
class ECR(IStrategy):
    """
    Enhanced Crash-Resistant (ECR) Long-Only Martingale DCA Strategy
    - Long-only, spot trading
    - Martingale-style DCA on dips
    - ATR-based fixed TP/SL per trade
    - Dynamic trailing stop
    - Fast reaction to crashes via profit-based triggers and filters
    """
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[reduce(lambda x, y: x & y, base_conditions), ['enter_long', 'enter_tag']] = (1, 'long_entry')
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[reduce(lambda x, y: x & y, conditions), ['exit_long', 'exit_tag']] = (1, 'long_exit')
        return dataframe
    ...
    def adjust_trade_position(self, trade: Trade, current_time: datetime,
        ...
        """
        Martingale DCA: multiplicatively increase stake on drawdowns
        Returns stake amount to add or None
        """
