# freqtrade hyperopt --hyperopt-loss ProfitDrawDownHyperOptLoss --spaces buy sell -c user_data/backtest-config.json --strategy InnovativeReversalStrategy --timerange=20240801-20240901 -e 200 --timeframe-detail 1m -p `cat pairs34` --timeframe 4h
import numpy as np
import pandas as pd
