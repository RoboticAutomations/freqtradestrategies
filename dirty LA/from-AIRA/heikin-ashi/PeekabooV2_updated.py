...
class PeekabooV2_updated(IStrategy):
    INTERFACE_VERSION = 3
    ...
    # Sell signal - UPDATED to use exit_profit_only instead of sell_profit_only
    use_exit_signal = True  # Updated from use_sell_signal for FreqTrade 2024+ compatibility
    exit_profit_only = True  # Changed from sell_profit_only
    exit_profit_offset = 0.01  # Updated from sell_profit_offset for FreqTrade 2024+ compatibility
    ignore_roi_if_entry_signal = False  # Updated from ignore_roi_if_buy_signal for FreqTrade 2024+ compatibility

    ## Optional order time in force.
    order_time_in_force = {
        'entry': 'gtc',
        'exit': 'gtc'
    }  # Updated from 'buy'/'sell' for FreqTrade 2024+ compatibility
    ...
    enable1 = BooleanParameter(default=True, space="buy", optimize=True)
    enable2 = BooleanParameter(default=True, space="buy", optimize=True)
    enable3 = BooleanParameter(default=True, space="buy", optimize=True)
    enable4 = BooleanParameter(default=True, space="buy", optimize=True)
    enable5 = BooleanParameter(default=True, space="buy", optimize=True)
    enable6 = BooleanParameter(default=True, space="buy", optimize=True)
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float, current_profit: float, **kwargs):  # Updated from custom_sell for FreqTrade 2024+ compatibility
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        #Bear Mode
            ...
            logger.debug(f"{pair} BEAR MODE!!!")
            dataframe.loc[:, 'MODE'] = -1
        #Blah Mode
        else:
            order = self.blah.value
            logger.debug(f"{pair} SIDEWAYS MODE!!!")
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[condition1, 'enter_tag'] = 'minima_check BULL UP'
        ...
        dataframe.loc[condition2, 'enter_tag'] = 'minima_check BULL MID'
        ...
        dataframe.loc[condition3, 'enter_tag'] = 'minima_check BULL DOWN'
        ...
        dataframe.loc[condition4, 'enter_tag'] = 'minima_check SIDEWAYS UP'
        ...
        dataframe.loc[condition5, 'enter_tag'] = 'minima_check SIDEWAYS MID'
        ...
        dataframe.loc[condition6, 'enter_tag'] = 'minima_check SIDEWAYS DOWN'
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[dataframe['maxima'] == 1, 'exit_tag'] = 'maxima'
        dataframe.loc[dataframe['maxima_check'] == 0, 'exit_tag'] = 'maxima_check'
