...
class Peekaboo(IStrategy):
    ...
    base_nb_candles_buy = IntParameter(80, 100, default=97, space='buy', optimize=True)
    bull = IntParameter(60, 80, default=72, space='buy', optimize=False)
    bear = IntParameter(490, 510, default=500, space='buy', optimize=False)
    blah = IntParameter(200, 225, default=225, space='buy', optimize=False)
    up = DecimalParameter(low=1.015, high=1.025, default=1.021, decimals=3 ,space='buy', optimize=True, load=True)
    dn = DecimalParameter(low=0.980, high=0.990, default=0.986, decimals=3 ,space='buy', optimize=True, load=True)
    ...
    def adjust_trade_position(self, trade: Trade, current_time: datetime,
        ...
        if current_profit > self.initial_safety_order_trigger:
            logger.info(f"{trade.pair} - Current Profit: {current_profit} Trigger: {self.initial_safety_order_trigger}")
            return None
    ...
    def custom_entry_price(self, pair: str, trade: Optional['Trade'], current_time: datetime, proposed_rate: float,
        ...
        entryprice = (dataframe['close'].iat[0] + dataframe['open'].iat[0] + proposed_rate) / 3
        logger.info(f"{pair} best entry {entryprice} close: {dataframe['close'].iat[0]} open: {dataframe['open'].iat[0]} proposed_rate: {proposed_rate}") 
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        #     ),
        #     ['enter_long', 'enter_tag']] = (1, 'minima BEAR')
        ...
        #     ),
        #    ['enter_long', 'enter_tag']] = (1, 'minima_check BEAR')
