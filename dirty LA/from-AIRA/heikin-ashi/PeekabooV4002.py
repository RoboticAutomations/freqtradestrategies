...
class PeekabooV4002(IStrategy):
    ...
    base_nb_candles_buy = IntParameter(150, 200, default=162, space='buy', optimize=True)
    ...
    increment = DecimalParameter(low=1.0005, high=1.001, default=1.0005, decimals=4 ,space='buy', optimize=True, load=True)
    quick = DecimalParameter(low=0.75, high=0.9, default=0.85, decimals=2 ,space='buy', optimize=True, load=True)
    m00n = DecimalParameter(low=1.60, high=1.80, default=1.64, decimals=2 ,space='buy', optimize=True, load=True)

    # Modulus    
    peaks = IntParameter(70, 200, default=126, space='buy', optimize=True) ### initial smallest window
    ...
    perc_target = DecimalParameter(low=1, high=5, default=2.3, decimals=1 ,space='buy', optimize=True, load=True)
    ...
    # Unclog Function
    days = IntParameter(2, 7, default=5, space='sell', optimize=True)
    loss = DecimalParameter(-0.07, -0.04, default=-0.052, space='sell', optimize=True)

    ### trailing stop loss optimiziation ###
    tsl_target3 = DecimalParameter(low=0.10, high=0.15, default=0.11, decimals=2,  space='sell', optimize=True, load=True)
    ts3 = DecimalParameter(low=0.025, high=0.04, default=0.03, decimals=3,  space='sell', optimize=True, load=True)
    tsl_target2 = DecimalParameter(low=0.06, high=0.10, default=0.091, decimals=3, space='sell', optimize=True, load=True)
    ts2 = DecimalParameter(low=0.015, high=0.03, default=0.027, decimals=3, space='sell', optimize=True, load=True)
    tsl_target1 = DecimalParameter(low=0.04, high=0.06, default=0.059, decimals=3, space='sell', optimize=True, load=True)
    ts1 = DecimalParameter(low=0.01, high=0.016, default=0.01, decimals=3, space='sell', optimize=True, load=True)
    tsl_target0 = DecimalParameter(low=0.04, high=0.05, default=0.044, decimals=3, space='sell', optimize=True, load=True)
    ts0 = DecimalParameter(low=0.005, high=0.012, default=0.007, decimals=3, space='sell', optimize=True, load=True)
    moon = IntParameter(80, 90, default=88, space='sell', optimize=True)
