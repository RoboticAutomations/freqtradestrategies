...
class ARIMA_FUTURES(IStrategy):
    ...
    # Modulus    
    peaks = IntParameter(70, 120, default=120, space='buy', optimize=True)
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Fill NaN values with the previous non-null values without using inplace=True
        dataframe['positive_expanding_mean'] = dataframe['positive_expanding_mean'].ffill()
        dataframe['negative_expanding_mean'] = dataframe['negative_expanding_mean'].ffill()
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[condition5, 'enter_tag'] += 'sell'
        ...
        dataframe.loc[condition6, 'enter_tag'] += 'maxima_check_1'
        ...
        dataframe.loc[condition7, 'enter_tag'] += 'maxima_check_below_2'
        ...
        dataframe.loc[condition8, 'enter_tag'] += 'maxima_check_below_1'

        return dataframe

    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        # Condição para sair de compra (long)
        condition5 = (
            (dataframe['decision'] == -1) &
            (dataframe['peak'].shift() == 1) &
            (dataframe['volume'] > 0)
        ...
        # Condição para sair de venda (short)
        condition11 = (
            (dataframe['decision'] == 1) &
            (dataframe['peak'].shift() == -1) &
            (dataframe['volume'] > 0)
        ...
        dataframe.loc[condition11, 'exit_short'] = 1
        dataframe.loc[condition11, 'exit_tag'] += 'minima_check_2'
        ...
        dataframe.loc[condition12, 'exit_short'] = 1
        dataframe.loc[condition12, 'exit_tag'] += 'minima_check_above_sma_2'

        condition13 = (
            (dataframe['peak_prominance'].shift(2) >= dataframe['positive_expanding_mean'].shift(2)) 
        )

        dataframe.loc[condition13, 'exit_short'] = 1
        dataframe.loc[condition13, 'exit_tag'] += 'minima_check_2'
        ...
        dataframe.loc[condition14, 'exit_tag'] += 'minima_check_above_sma_2'
        ...
        dataframe.loc[condition15, 'exit_tag'] += 'minima_check_1'
        ...
        dataframe.loc[condition16, 'exit_short'] = 1
        dataframe.loc[condition16, 'exit_tag'] += 'minima_check_above_sma_1'
