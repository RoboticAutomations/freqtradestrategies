# freqtrade hyperopt --hyperopt-loss ProfitDrawDownHyperOptLoss --spaces buy roi trades  --strategy NOTankAi_5 --config user_data/NOTankAi_5_spot.json --timerange 20240801-20240831 -e 200 --timeframe-detail 1m  -p `cat pairs34`
# freqtrade backtesting --strategy NOTankAi_5 --config user_data/NOTankAi_5_spot.json --timerange 20240801-20240831  -p `cat pairs50` --max-open-trade=-1 --cache none --timeframe-detail=1m
#
#
