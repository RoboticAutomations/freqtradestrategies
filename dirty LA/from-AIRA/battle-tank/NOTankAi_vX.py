    ...
    def populate_entry_trend(self, df: DataFrame, metadata: dict) -> DataFrame:
        ...
        df.loc[
            (
                ...
                & (df["rsi"] < 25)  # RSI abaixo de 30 (condição adicional para limitar entradas)
            ),
        ...
        df.loc[
            (
                ...
                & (df["volume"] > 0)  # Volume maior que 0
                & (df["rsi"] > 75)  # RSI acima de 70 (condição adicional para limitar entradas)
            ),
