...
class TankAi15(IStrategy):
    ...
    def leverage(self, pair: str, current_time: 'datetime', current_rate: float,
        ...
        long_increase_factor = 20  # Increase  the base leverage for long positions
        long_decrease_factor = 8  # Decrease  the base leverage for long positions
        short_increase_factor = 20  # Increase  base leverage for short positions
        short_decrease_factor = 8  # Decrease  the base leverage for short positions
        volatility_decrease_factor = 10  # Decrease to 10 the base leverage when volatility is high
