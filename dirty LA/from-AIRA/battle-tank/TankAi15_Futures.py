...
class TankAi15(IStrategy):
    ...
    def custom_entry_price(self, pair: str, trade: Optional['Trade'], current_time: datetime, proposed_rate: float,
        ...
        if self.last_entry_price is not None and abs(entry_price - self.last_entry_price) < 0.0005:  # Tolerance for floating-point comparison
    ...
    def leverage(self, pair: str, current_time: 'datetime', current_rate: float,
        ...
        long_increase_factor = 1.5  # Increase leverage to double the base leverage for long positions
        long_decrease_factor = 0.5  # Decrease leverage to half the base leverage for long positions
        short_increase_factor = 1.5  # Increase leverage to double the base leverage for short positions
